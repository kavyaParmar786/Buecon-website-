      ...
      subCategories: [
        ...
        },
        {
          ...
          products: [
            ...
            { id:'soft-5',  name:'Soft Tumbler Holder',    desc:'Single tumbler holder with soft round profile. Gentle on surfaces, beautiful on walls. SS-1503', image:'public/images/soft-tumbler-holder.png' },
            ...
            { id:'soft-8',  name:'Soft Napkin Ring',       desc:'Smooth-contoured napkin ring with soft matte finish. Gentle curves, premium durability. SS-1504', image:'public/images/soft-napkin-ring.png' },
            { id:'soft-9',  name:'Soft Spare Paper',       desc:'Spare paper holder with soft-close arm. Pairs perfectly with the Soft Series suite. SS-1504S', image:'public/images/soft-spare-paper.png' },
        ...
        },
        {
          ...
          products: [
            { id:'smart-1',  name:'Smart Paper Lid',         desc:'Covered paper holder with lid. Water-saving design with premium brushed finish. SS-2309L', image:'public/images/smart-paper-lid.png' },
            { id:'smart-2',  name:'Smart Robe Hook',         desc:'Sleek robe hook with Smart Series round profile. Auto shut-off compatible bracket. SS-2306', image:'public/images/smart-robe-hook.png' },
            ...
            { id:'smart-15', name:'Smart Spare Paper',       desc:'Spare paper holder with Smart round profile. Auto-activates when needed. SS-2323', image:'public/images/smart-spare-paper.png' },
          ]
        }
      ]
    },
      ...
      ${products.map(p => `
        <div class="product-card-new" onclick="openProductModal(${JSON.stringify(JSON.stringify(p))})">
          ...
          <div class="product-card-info">
            ...
            <span class="product-card-link">Enquire →</span>
          </div>
        </div>`).join('')}
    </div>`;
}
    ...
    <div class="pm-card">
      ...
      <div class="pm-inner">
        ...
        <div class="pm-info">
          ...
          <a class="pm-enquire" href="#contact" onclick="closeProductModal();setTimeout(()=>document.getElementById('contact')?.scrollIntoView({behavior:'smooth'}),300)">
